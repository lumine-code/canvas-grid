...
class CanvasGrid {
  ...
  drawSelectionHeaders(
    ...
    for (let column = firstColumn; column <= lastColumn; column++) {
      if (
        ...
        continue;
      const left = this.columnStarts[column] - this.element.scrollLeft;
  ...
  handleMouseMove(event) {
    ...
    const clientWidth = this.element.clientWidth || this.viewWidth;
    const clientHeight = this.element.clientHeight || this.viewHeight;
